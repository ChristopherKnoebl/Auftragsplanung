...
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (1, 1, 1, 5);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (2, 1, 3, 15);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (3, 1, 4, 0.5);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (4, 2, 2, 7);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (5, 2, 3, 15);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (6, 2, 4, 0.5);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (7, 3, 1, 3);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (8, 3, 3, 25);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (9, 3, 4, 0.5);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (10, 4, 2, 3);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (11, 4, 3, 25);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (12, 4, 4, 0.25);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (13, 5, 1, 5);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (14, 5, 2, 4);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (15, 5, 3, 15);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (16, 5, 4, 0.5);
INSERT OR REPLACE INTO Produkt_Material_Verbund Values (17, 5, 5, 8)
"""
cursor.executescript(sql_script)
connection.commit()
...
cursor = connection.cursor()
sql_script = """
CREATE TABLE Fertigungsaufträge( ID  INTEGER PRIMARY KEY, Menge float, ProduktID int, Auftragsbeginn text, Auftragsende text,
FOREIGN KEY (ProduktID) REFERENCES Produkt(ID));

"""
# Insert or replace Into Fertigungsaufträge Values (1, 20, 01.01.2024, 12.12.2024)
